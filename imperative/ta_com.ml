...
# Anno          : 2016-17
# Corso         : Informatica
# Descrizione   : taint analisi su comandi (1)
# Nome File     : ta_com.ml
# ------------------------------------------------ 
#
*)
...
(* INPUT *)
let d = [("w",Newloc(Eint 0))];;
let (rho5,sigma5) = semdv d rho5 sigma5;;
let s = Assign(Den "w",Prod(Val(Den "cx"),Val(Den "dx")));;

(* START *)
let (rho,sigma) = taintc(s,rho5,sigma5);;
