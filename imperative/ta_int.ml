...
# Anno          : 2016-17
# Corso         : Informatica
# Descrizione   : taint analisi su interi
# Nome File     : ta_int.ml
# ------------------------------------------------ 
#
*)
...
(* DATI INPUT *)
let ax = Eint 10;; (* taint   *)
let bx = Eint 0 ;; (* taint   *)
let cx = Eint 10;; (* untaint *)
let dx = Eint 0 ;; (* untaint *)
...
(* INPUT *)
let s = Sum(Sum(Val(Den "ax"),Val(Den "cx")),Val(Den "cx"));;
(* let s = Prod(Sum(Val(Den "ax"),Val(Den "ax")),Val(Den "dx"));; *)
